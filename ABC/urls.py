...
urlpatterns = [
    ...
    url(r'new_item/(?P<item_id>[0-9]*)/$', views.new_item, name='new_item'),
    ...
    url(r'new_provider/(?P<provider_id>[0-9]*)/$', views.new_provider, name='new_provider'),
    url(r'delete_provider/(?P<provider_id>[0-9]*)/$', views.delete_provider, name='delete_provider'),
    url(r'modify_provider/$', views.modify_provider, name='modify_provider'),
    ...
    url(r'new_customer/(?P<customer_id>[0-9]*)/$', views.new_customer, name='new_customer'),
    url(r'delete_customer/(?P<customer_id>[0-9]*)/$', views.delete_customer, name='delete_customer'),
    url(r'modify_customer/$', views.modify_customer, name='modify_customer'),
    ...
    url(r'new_order/(?P<order_id>[0-9]*)/$', views.new_order, name='new_order'),
    ...
    url(r'new_event/(?P<event_id>[0-9]*)/$', views.new_event, name='new_event'),
    url(r'delete_event/(?P<event_id>[0-9]*)/$', views.delete_event, name='delete_event'),
    url(r'modify_event/$', views.modify_event, name='modify_event'),
    ...
    url(r'new_delivery_type/(?P<delivery_type_id>[0-9]*)/$', views.new_delivery_type, name='new_delivery_type'),
    url(r'delete_delivery_type/(?P<delivery_type_id>[0-9]*)/$', views.delete_delivery_type, name='delete_delivery_type'),
    url(r'modify_delivery_type/$', views.modify_delivery_type, name='modify_delivery_type'),
    ...
    url(r'new_payment_type/(?P<payment_type_id>[0-9]*)/$', views.new_payment_type, name='new_payment_type'),
    url(r'delete_payment_type/(?P<payment_type_id>[0-9]*)/$', views.delete_payment_type, name='delete_payment_type'),
    url(r'modify_payment_type/$', views.modify_payment_type, name='modify_payment_type'),
    url(r'new_vat_type/$', views.new_vat_type, name='new_vat_type'),
    url(r'new_vat_type/(?P<vat_type_id>[0-9]+)/$', views.new_vat_type, name='new_vat_type'),
    url(r'add_vat_type/$', views.add_vat_type, name='add_vat_type'),
    url(r'add_vat_type/(?P<vat_type_id>[0-9]*)/$', views.add_vat_type, name='add_vat_type'),
    url(r'delete_vat_type/(?P<vat_type_id>[0-9]+)/$', views.delete_vat_type, name='delete_vat_type'),
    url(r'modify_vat_type/$', views.modify_vat_type, name='modify_vat_type'),
