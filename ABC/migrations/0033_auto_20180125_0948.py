# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-25 09:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='order',
            name='document',
            field=models.FileField(blank=True, default=None, upload_to='items'),
        ),
        migrations.AlterField(
            model_name='order',
            name='notes',
        ...
        migrations.AlterField(
            model_name='paymenttype',
            name='cost',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='EUR', max_digits=5),
        ),
    ]
